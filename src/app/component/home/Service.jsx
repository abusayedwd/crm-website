...
const ServicePage = () => {
  return (
    <div className="container mx-auto px-4">
      ...
      {/* Service Section */}
      <h2 className="text-[44px] md:text-3xl font-bold  mb-6">
        Our Service
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-8 py-6">
      {/* Service Card 1 */}
      <div className="relative rounded-lg overflow-hidden shadow-lg">
        <Image src={service2} alt="service" className="w-full h-64  md:h-60 lg:h-72 object-cover opacity-80" />
      ...
      {/* Service Card 2 */}
      <div className="relative rounded-lg overflow-hidden shadow-lg">
        <Image src={service1} alt="service" className="w-full h-64  md:h-60 lg:h-72 object-cover opacity-80" />
        <div className="absolute bottom-0 left-0 right-0 bg-orange-600 bg-opacity-70 p-4 text-white">
          <h3 className="text-lg md:text-xl font-medium">Electro Technical</h3>
          <button className="underline text-sm">View more</button>
        </div>
